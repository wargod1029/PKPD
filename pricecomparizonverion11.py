...
def price_finder():
    tpath = int(input('Please input the local address of the web store you want to find the price separetely\n (Type 1 for Store 1, type 2 for Store 2, and type 3 for Store 3)\n'))
    if tpath == (1):
        path = dp1
    else: 
        if tpath == (2):
...
def compare():
    count = int(input('Please input the no. of store you want to find (type "0" if you want to compare with all store that default to be compare)\n'))
    ...
    if count == 0:        
        ...
        print(f'Please input the local address of the web store you want to compare separetely\n (Type 1 for Store 1, type 2 for Store 2, and type 3 for Store 3)\n')
        for temp in range(count):
            
            if temp != 0:
                print(f'Please type another web address\n (Type 1 for Store 1, type 2 for Store 2, and type 3 for Store 3)\n')
